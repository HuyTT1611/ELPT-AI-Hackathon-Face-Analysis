...
def argument_parser():
    ...
    parser.add_argument("--images_dir", type=str, default='./public_test')

    parser.add_argument("--json_dir", type=str, default='./public_test_and_submission_guidelines/file_name_to_image_id.json')
