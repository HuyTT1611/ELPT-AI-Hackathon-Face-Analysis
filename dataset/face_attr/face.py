...
class FaceAttrHackathon(data.Dataset):
...
class FaceAttrHackathonText(data.Dataset):
...
class FaceAttrHackathonInfer(data.Dataset):
...
class FaceAttrHackathonInferTestPhase(data.Dataset):
