...
def swin_small_patch4_window7_224(pretrained="./pretrained/swin_small_patch4_window7_224_22k.pth", convert_weights=True, img_size=224,drop_rate=0.0, attn_drop_rate=0.0, drop_path_rate=0., **kwargs):
